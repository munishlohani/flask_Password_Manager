  ...
  return (
    <>
      <div className="w-[95vw] overflow-hidden h-[100vh] flex relative z-50">
        ...
        {/* Left Sidebar */}
        <div
          className={`left z-10 absolute md:fixed transition-all duration-300 ease-in ${
            isOpen
              ? "opacity-100 md:translate-x-0 w-[40] md:w-[22vw]"
              : "invisible opacity-0 md:-translate-x-[1000%]"
          } md:w-[20vw] bg-zinc-800 h-full m-0 p-0 rounded-md w-[60vw]`}
        >
        ...
        <div className="right flex flex-col w-full p-1 sm:ml-[15vw]">
          ...
          {data && (
            <div className="border-t-1 flex flex-col ">
              <div className="header flex gap-3 rounded-sm w-full md:text-xl justify-between md:justify-evenly items-center content-center md:text-left p-2 border-b-1 border-zinc-700 text-[10px] invisible md:visible">
